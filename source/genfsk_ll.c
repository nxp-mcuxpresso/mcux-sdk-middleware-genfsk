...
#if (defined(SDK_COMPONENT_INTEGRATION) && (SDK_COMPONENT_INTEGRATION > 0))
static void GENFSK_Task(osa_task_param_t argument);
#else  /*SDK_COMPONENT_INTEGRATION > 0*/
...
static OSA_TASK_DEFINE(GENFSK_Task, gGENFSK_TaskPriority_c, 1, gGENFSK_TaskStackSize_c, 0U);
...
#if (defined(SDK_COMPONENT_INTEGRATION) && (SDK_COMPONENT_INTEGRATION > 0))
static OSA_TASK_HANDLE_DEFINE(gGenfskTaskId);
#else  /*SDK_COMPONENT_INTEGRATION > 0*/
static osaTaskId_t gGenfskTaskId = NULL;
#endif /*SDK_COMPONENT_INTEGRATION > 0*/

#if (defined(SDK_COMPONENT_INTEGRATION) && (SDK_COMPONENT_INTEGRATION > 0))
OSA_EVENT_HANDLE_DEFINE(mGenfskTaskEvent);
#else  /*SDK_COMPONENT_INTEGRATION > 0*/
...
genfskStatus_t GENFSK_Init(void)
{
    ...
    else
    {
...
#if (defined(SDK_COMPONENT_INTEGRATION) && (SDK_COMPONENT_INTEGRATION > 0))
        if (KOSA_StatusSuccess != OSA_EventCreate((osa_event_handle_t)mGenfskTaskEvent, 1U))
#else  /*SDK_COMPONENT_INTEGRATION > 0*/
        ...
        {
#if (defined(SDK_COMPONENT_INTEGRATION) && (SDK_COMPONENT_INTEGRATION > 0))
            if (KOSA_StatusSuccess != OSA_TaskCreate((osa_task_handle_t)gGenfskTaskId, OSA_TASK(GENFSK_Task), NULL))
#else  /*SDK_COMPONENT_INTEGRATION > 0*/
...
#endif
#if defined(HDI_MODE) && (HDI_MODE == 1)
            HDI_SendChannelSwitchCmd(channelNum);
#endif
        }
    }
...
static void GENFSK_Task(osaTaskParam_t argument)
{
    ...
    {
#if (defined(SDK_COMPONENT_INTEGRATION) && (SDK_COMPONENT_INTEGRATION > 0))
        (void)OSA_EventWait((osa_event_handle_t)mGenfskTaskEvent, osaEventFlagsAll_c, 0U, osaWaitForever_c, &osaev);
#else  /*SDK_COMPONENT_INTEGRATION > 0*/
...
#if (defined(SDK_COMPONENT_INTEGRATION) && (SDK_COMPONENT_INTEGRATION > 0))
                (void) OSA_EventClear((osa_event_handle_t)mGenfskTaskEvent, gGenfskMwsReleaseEventFlag_c);
#else  /*SDK_COMPONENT_INTEGRATION > 0*/
